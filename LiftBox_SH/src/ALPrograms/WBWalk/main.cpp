...
//        std::cout << "pRH x = " << wbwalk.fkik.desired.pRH_3x1[0] << std::endl;
//        std::cout << "pRH y = " << wbwalk.fkik.desired.pRH_3x1[1] << std::endl;
//        std::cout << "pRH z = " << wbwalk.fkik.desired.pRH_3x1[2] << std::endl;
