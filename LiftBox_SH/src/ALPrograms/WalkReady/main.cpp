...
//                //sharedData->STATE_COMMAND = TCMD_WHEEL_POS_CHANGE_WH2WALK_DONE;
            ...
            else if(sharedData->COMMAND[PODO_NO].USER_PARA_INT[0] == 14){
                GotoWalkReadyPos_LB();
                usleep(4000*1000);
                sharedData->STATE_COMMAND = TCMD_WALKREADY_DONE;
            }
...
//    joint->SetMoveJoint(LWP, 0.0, postime, MOVE_ABSOLUTE);
    ...
    des_pCOM_3x1[0] = userData->WalkReadyCOM[0] = 0.00; //0.0237f;
    des_pCOM_3x1[1] = userData->WalkReadyCOM[1] = 0.00;
...
//   double FK_COM[3] = {0.,};
//   kine_drc_hubo.FK_COM_Global(WBIK_Q0,FK_COM);
//   std::cout << "FK_COM[0]: " << FK_COM[0] << std::endl;
//   std::cout << "FK_COM[1]: " << FK_COM[1] << std::endl;
//   std::cout << "FK_COM[2]: " << FK_COM[2] << std::endl;
...
void GotoWalkReadyPos_LB(){
    ...
    FILE_LOG(logSUCCESS) << "GotoWalkReadyPos_LB()";
