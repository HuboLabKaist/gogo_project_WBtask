...
//        std::cout << "From encoder" << std::endl;
...
//            if(JointReference(i))
//                std::cout<< "JointReference(" << i << ")= " << JointReference(i) * D2Rf << std::endl;
        }

        glWidget->model->ref[RHAND+7]= JointReference(RHAND) * D2Rf;
        glWidget->model->ref[LHAND+7]= JointReference(LHAND) * D2Rf;
...
//    std::cout<< "glWidget->model->ref[mRHAND]= " << glWidget->model->ref[RHAND+7] << std::endl;
//    std::cout<< "glWidget->model->ref[mLHAND]= " << glWidget->model->ref[LHAND+7] << std::endl;
...
//    glWidget->model->ref[LF_c1+7] = glWidget->model->ref[LF_c2+7] = glWidget->model->ref[LF_c3+7] = (-100/36.2)*(36.2-JointEncoder(LHAND))*D2Rf;
    ...
    // Fingers always use encoder
    glWidget->model->ref[RF_a1+7] = glWidget->model->ref[RF_a2+7] = glWidget->model->ref[RF_a3+7] =  RHAND_ref;
    glWidget->model->ref[RF_b1+7] = glWidget->model->ref[RF_b2+7] = glWidget->model->ref[RF_b3+7] =  RHAND_ref;
    glWidget->model->ref[RF_c1+7] = glWidget->model->ref[RF_c2+7] = glWidget->model->ref[RF_c3+7] = -RHAND_ref;

    glWidget->model->ref[LF_a1+7] = glWidget->model->ref[LF_a2+7] = glWidget->model->ref[LF_a3+7] =  LHAND_ref;
    glWidget->model->ref[LF_b1+7] = glWidget->model->ref[LF_b2+7] = glWidget->model->ref[LF_b3+7] =  LHAND_ref;
    glWidget->model->ref[LF_c1+7] = glWidget->model->ref[LF_c2+7] = glWidget->model->ref[LF_c3+7] = -LHAND_ref;
