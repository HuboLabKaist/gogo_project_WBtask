    ...
    ui(new Ui::WBTask)
{
    ...
    Alnum_gogoCart      = PODOALDialog::GetALNumFromALName("gogoCart");
...
//WALKING
void WBTask::on_PB_WKRD_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_PositionWalking_clicked()
{
    USER_COMMAND cmd;
...
//JOYSTICK
void WBTask::on_JOY_BTN_START_clicked()
{
    // Joy Stick Start
    JoyModeFlag=true;
...
void WBTask::on_JOY_BTN_STOP_clicked()
{
...
void WBTask::on_MANUAL_BTN_JOY_WALKING_ON_clicked()
{
...
void WBTask::on_MANUAL_BTN_JOY_WALKING_OFF_clicked()
{
...
void WBTask::GetJoystickData(void)
{
...
void WBTask::InitJoystickData(void)
{
    JOY_LT=JOY_LB=0;
...
//LIFT BOX
void WBTask::on_PB_Back_LiftBox_clicked()
{
...
void WBTask::on_PB_Back_PutBox_clicked()
{
    printf("BACK_PUTBOX\n");
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
...
void WBTask::on_PB_ALLinOne_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_STOP_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
...
//MOVE BOX
void WBTask::on_PB_MB_LB_WalkReady_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_MB_STOP_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_STOP;
...
void WBTask::on_PB_MB_liftBox_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_MB_putBox_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_MOVEBOX;
...
void WBTask::on_PB_MB_WKRD_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_COMxBackWalking_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND        = 118;//HBWalking_WALK_TEST;
    cmd.COMMAND_DATA.USER_PARA_INT[0]    = ui->LE_NO_OF_STEP->text().toInt();
    ...
    //TEST
    cmd.COMMAND_DATA.USER_PARA_INT[15]   = 10;

    cmd.COMMAND_TARGET = AlnumHBWalking_COM;
    pLAN->SendCommand(cmd);
//    JOY_X = 1;
//    PB_COMWalk_flag = true;
}

//CART
void WBTask::on_PB_Cart_LB_WKRD_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_CART_STOP_clicked()
{
    USER_COMMAND cmd;
//    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
    cmd.COMMAND_TARGET = Alnum_gogoCart;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_STOP;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = CART_APPROACH;
    pLAN->SendCommand(cmd);
}

void WBTask::on_PB_holdCart_clicked()
{
    USER_COMMAND cmd;
//    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
    cmd.COMMAND_TARGET = Alnum_gogoCart;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_UB;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = CART_HOLDCART;
    pLAN->SendCommand(cmd);
}

void WBTask::on_PB_CART_Walking_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND        = 118;//HBWalking_WALK_TEST;
    cmd.COMMAND_DATA.USER_PARA_INT[0]    = ui->LE_NO_OF_STEP->text().toInt();
...
void WBTask::on_PB_ReleaseCart_clicked()
{
    USER_COMMAND cmd;
//    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
    cmd.COMMAND_TARGET = Alnum_gogoCart;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_UB;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = CART_RELEASECART;
    pLAN->SendCommand(cmd);
}

//GRIPPER
void WBTask::on_PB_G_open_clicked()
{
    USER_COMMAND cmd;
...
void WBTask::on_PB_G_close_half_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_GRIPPER;
...
void WBTask::on_PB_G_close_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_GRIPPER;
...
//SAVE DATA
void WBTask::on_PB_SaveStart_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
...
void WBTask::on_PB_SaveDone_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = ALNUM_gogoLiftBox;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_SAVE;
...
void WBTask::on_PB_SaveStart_HB_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = AlnumHBWalking;
...
void WBTask::on_PB_SaveDone_HB_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = AlnumHBWalking;
    cmd.COMMAND_DATA.USER_COMMAND = 101;    //HBWalking_DATA_SAVE
...
void WBTask::on_PB_SaveStart_Cart_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = Alnum_gogoCart;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_SAVE;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = true; // Save Start
    pLAN->SendCommand(cmd);

}

void WBTask::on_PB_SaveDone_Cart_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = Alnum_gogoCart;
    cmd.COMMAND_DATA.USER_COMMAND = LIFTBOX_SAVE;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = false; // Save Start
    pLAN->SendCommand(cmd);
