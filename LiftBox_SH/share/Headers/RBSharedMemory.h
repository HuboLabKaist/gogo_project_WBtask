...
typedef struct _RBCORE_SHM_
{
    ...
    //ADD MORE VARIABLES
    double COM_SH[3]             = {0.,};
    double COM_SH_ref[3]         = {0.,};
    double COM_m_local[3]        = {0.,};
    double COM_m_local_filter[3] = {0.,};
//    std::vector<double> COM_m_local = {0., 0., 0.};

    //ZMP from HBWalking
    double zmp_HBWalk[3] = {0, };
    double zmp_HBWalk_ref[3] = {0, };
    double zmp_HBWalk_com[3] = {0, };
    double zmp_HBWalk_com_ref[3] = {0, };


    //JERK Test
    double         gogo_Reference[43] = {0.,};
    double         HBWK_Reference[43] = {0.,};

    //WALKING COM MOVE
    int walkingMode = 0;   // 0: original, 1:COM -5cm

    //clac_ZMP
    double ZMP_SH[3] = {0, };
    double COM_SH_cal[2] = {0, };

    //COM_RESET Flag
    int Flag_COMreset = false;
